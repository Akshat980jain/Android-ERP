...
export function TransportModule() {
  ...
  return (
    <motion.div className="space-y-6" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
      ...
      {loading ? (
        <div className="text-center py-8 text-gray-500 dark:text-gray-400">Loading transport routes...</div>
      ) : routes.length === 0 ? (
        <Card>
          <CardContent className="text-center py-12">
            <Bus className="w-12 h-12 text-gray-400 mx-auto mb-4" />
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">No transport routes</h3>
            <p className="text-gray-600 dark:text-gray-400">No transport routes are currently available.</p>
          </CardContent>
        </Card>
      ) : (
                ...
                <div className="space-y-4">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 dark:text-gray-100">Route {route.routeNumber}</h3>
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Stops:</h4>
