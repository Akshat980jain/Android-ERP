...
export function EventModule() {
  ...
  const fetchEvents = async () => {
    ...
    try {
      ...
      const data = await apiClient.getEvents(params) as any;
  ...
  const getEventTypeColor = (type: string) => {
    const colors = {
      workshop: 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400',
      seminar: 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400',
      conference: 'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-400',
      cultural: 'bg-pink-100 text-pink-800',
      sports: 'bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-400',
    ...
    <motion.div className="space-y-6" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Events & Activities</h1>
        </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">{event.title}</h3>
